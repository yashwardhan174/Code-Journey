    ...
    <div class="hidden lg:flex lg:gap-x-12">
        ...
        <div id="product-menu" class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-xl bg-gray-100 shadow-lg ring-1 ring-gray-900/5 opacity-0 translate-y-1 transition-all duration-200 ease-out pointer-events-none">
            ...
            <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-300">
                ...
                <div class="flex-auto">
                <a href="dbjsp" class="block font-semibold text-black">
                    Databases (DB)
                    <span class="absolute inset-0"></span>
                </a>
                <p class="mt-1 text-gray-900">Store, manage, and retrieve data</p>
        ...
        <a id="roadmap-link" href="roadmap.jsp" class="text-md font-bold leading-6 text-white hover:text-blue-400 transition-all hover:scale-110">Roadmap</a>
        <a id="marketplace" href="marketplace.jsp" class="text-md font-bold leading-6 text-white hover:text-blue-400 transition-all hover:scale-110">Marketplace</a>
        <a id="company-link" href="company.jsp" class="text-md font-bold leading-6 text-white hover:text-blue-400 transition-all hover:scale-110">Company</a>
    </div>
        ...
        <div class="-my-6 divide-y divide-gray-500/10">
            ...
            <div class="-mx-3">
                ...
                <div id="mobile-product-dropdown" class="ml-6 space-y-2">
                    ...
                    <a href="jsjsp" class="block text-base font-semibold leading-7 text-gray-900 transition-all hover:text-white hover:px-1">JavaScript</a>
                    <a href="dbjsp" class="block text-base font-semibold leading-7 text-gray-900 transition-all hover:text-white hover:px-1">Databases</a>
                </div>
            </div>
...
<footer class="w-full bg-gradient-to-r from-slate-500 to-slate-800 px-4 text-white pt-8 flex flex-col md:flex-row flex-wrap justify-between md:px-12 py-10">
    ...
    <div class="text-left">
        ...
        <ul>
            ...
            <li class="my-1 transition-all duration-300 text-white font-semibold hover:text-blue-400 hover:transform hover:translate-x-2">
                <a href="jsjsp">JavaScript</a>
            </li>
            <li class="my-1 transition-all duration-300 text-white font-semibold hover:text-blue-400 hover:transform hover:translate-x-2">
                <a href="dbjsp">Databases</a>
            </li>
...
<script>
// Check if the URL contains the loginFirst=true parameter
window.onload = function() {
    const urlParams = new URLSearchParams(window.location.search);
    const loginFirst = urlParams.get('loginFirst');

    if (loginFirst === 'true') {
        // Show the alert if loginFirst flag is true
