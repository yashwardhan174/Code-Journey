...
<div class="max-w-6xl mx-auto p-6 space-y-12 mb-12">
    ...
    <div class="text-center mb-12 relative overflow-hidden p-8 bg-gradient-to-r from-gray-100 via-white to-gray-100 rounded-lg shadow-lg mt-12">
        <h1 class="text-4xl font-extrabold text-gray-800 mb-4">Top IT Companies</h1>
        <p class="text-gray-600 text-lg font-medium mb-6">Explore some of the leading IT companies shaping the tech industry.</p>
    ...
    <div class="bg-yellow-100 p-6 rounded-lg shadow-md mb-6 hover:scale-105 transition-all cursor-pointer">
        <h2 class="text-2xl font-bold text-gray-700 mb-2">1. Google</h2>
        <p class="text-gray-600">Google is known for its powerful search engine, as well as its work in AI, cloud computing, and Android development.</p>
    </div>

    <!-- 2. Microsoft -->
    <div class="bg-green-100 p-6 rounded-lg shadow-md mb-6 hover:scale-105 transition-all cursor-pointer">
        <h2 class="text-2xl font-bold text-gray-700 mb-2">2. Microsoft</h2>
        <p class="text-gray-600">Microsoft excels in software development, cloud services (Azure), and is the creator of Windows, Office, and Xbox.</p>
    </div>

    <!-- 3. Amazon -->
    <div class="bg-blue-100 p-6 rounded-lg shadow-md mb-6 hover:scale-105 transition-all cursor-pointer">
        <h2 class="text-2xl font-bold text-gray-700 mb-2">3. Amazon</h2>
        <p class="text-gray-600">Amazon dominates e-commerce and cloud computing with AWS, a leader in providing scalable cloud solutions globally.</p>
    </div>

    <!-- 4. Apple -->
    <div class="bg-purple-100 p-6 rounded-lg shadow-md mb-6 hover:scale-105 transition-all cursor-pointer">
        <h2 class="text-2xl font-bold text-gray-700 mb-2">4. Apple</h2>
        <p class="text-gray-600">Apple is renowned for its innovation in consumer electronics, including the iPhone, Mac, and software ecosystems like iOS and macOS.</p>
    </div>

    <!-- 5. IBM -->
    <div class="bg-pink-100 p-6 rounded-lg shadow-md mb-6 hover:scale-105 transition-all cursor-pointer">
        <h2 class="text-2xl font-bold text-gray-700 mb-2">5. IBM</h2>
        <p class="text-gray-600">IBM is a pioneer in AI, mainframe computing, and cloud services, with a strong focus on enterprise solutions.</p>
    </div>

    <!-- 6. Facebook (Meta) -->
    <div class="bg-teal-100 p-6 rounded-lg shadow-md mb-6 hover:scale-105 transition-all cursor-pointer">
        <h2 class="text-2xl font-bold text-gray-700 mb-2">6. Facebook (Meta)</h2>
        <p class="text-gray-600">Meta is a leader in social media and virtual reality, with a focus on building the metaverse and advancing AI technologies.</p>
    </div>

    <!-- 7. Tencent -->
    <div class="bg-red-100 p-6 rounded-lg shadow-md mb-6 hover:scale-105 transition-all cursor-pointer">
        <h2 class="text-2xl font-bold text-gray-700 mb-2">7. Tencent</h2>
        <p class="text-gray-600">Tencent is a major player in social networking, gaming, and mobile payments, and is known for apps like WeChat and QQ.</p>
    </div>

    <!-- 8. Oracle -->
    <div class="bg-lime-100 p-6 rounded-lg shadow-md mb-6 hover:scale-105 transition-all cursor-pointer">
        <h2 class="text-2xl font-bold text-gray-700 mb-2">8. Oracle</h2>
        <p class="text-gray-600">Oracle is known for its database technology and cloud services, and is a key provider of enterprise software solutions.</p>
    </div>

    <!-- 9. SAP -->
    <div class="bg-indigo-100 p-6 rounded-lg shadow-md mb-6 hover:scale-105 transition-all cursor-pointer">
        <h2 class="text-2xl font-bold text-gray-700 mb-2">9. SAP</h2>
        <p class="text-gray-600">SAP specializes in enterprise software for managing business operations and customer relations.</p>
    </div>

    <!-- 10. Salesforce -->
    <div class="bg-orange-100 p-6 rounded-lg shadow-md mb-6 hover:scale-105 transition-all cursor-pointer">
        <h2 class="text-2xl font-bold text-gray-700 mb-2">10. Salesforce</h2>
        <p class="text-gray-600">Salesforce is a leading cloud-based CRM platform, providing solutions for sales, marketing, and customer support.</p>
    </div>
</div>
<!-- Section Ends -->
